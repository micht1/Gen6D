...
def main(args):
    ...
    for que_id in tqdm(range(que_num)):
        img_path='/home/tobias/Thesis_tobias/poseEstimation_grasping/Gen6D/data/dataset/rgb{}'.format(que_id)
        img = imread(img_path)
        # generate a pseudo K
        h, w, _ = img.shape
        K = np.asarray([[876.6438802083333, 0.0, 319.5],[0.0, 876.6438802083333, 239.5],[ 0.0, 0.0, 1.0]],np.float32)
